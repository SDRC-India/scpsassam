...
<body ng-app="loginApp" ng-controller="loginController">
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-md-4 col-xs-3 ipadPotraitView">
				<div class="panel panel-default panelBox ">
					<div class="panel-body login-window">
						<fieldset>
							<div class="row">
								<div class="center-block">
									<img class="cpisloginsvgheight"
										src="resources/images/scps_icon_2.svg">
									<h3 class="sign-up-title">SCPS Assam</h3>
								</div>
							</div>
...
$(document).ready(function(){
	if( $(".alert")[0] != undefined){
		$("#errMsg").fadeTo(2000, 0).slideUp(500, function(){
		    $("#errMsg").slideUp(500);
		});
	}
});
